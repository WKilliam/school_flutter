                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child:
                                      TextField(
                                        controller: snapshot.data['Controller1'],
                                        readOnly: true,
                                        ...
                                        onTap: () async {
                                          ...
                                          if (pickedDate != null) {
                                            String formattedDate = DateFormat(
                                                'yyyy-MM-dd').format(
                                                pickedDate);
                                            bloc?.updateController1Text(
                                                "Controller1", formattedDate);
                                            bloc?.update1(
                                                'Friend_day1', pickedDate.day);
                                            bloc?.update1('Friend_mouth1',
                                                pickedDate.month);
                                            bloc?.update1('Friend_year1',
                                                pickedDate.year);
                                          } else {
                                    ...
                                    Container(
                                      ...
                                      child:
                                      TextField(
                                        controller: snapshot.data['Controller2'],
                                        readOnly: true,
                                        //set it true, so that user will not able to edit text
                                        onTap: () async {
                                          DateTime? pickedDate = await showDatePicker(
                                          ...
                                          if (pickedDate != null) {
                                            String formattedDate = DateFormat(
                                                'yyyy-MM-dd').format(
                                                pickedDate);
                                            bloc?.updateController2Text(
                                                "Controller2", formattedDate);
                                            bloc?.update2(
                                                'Friend_day2', pickedDate.day);
                                            bloc?.update2('Friend_mouth2',
                                                pickedDate.month);
                                            bloc?.update2('Friend_year2',
                                                pickedDate.year);
                                          } else {
                                            print("Date is not selected");
                                          }
